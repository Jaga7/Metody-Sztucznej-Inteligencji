...
class RandomSubspaceEnsemble(BaseEnsemble, ClassifierMixin):
    ...
    def __init__(self, base_estimator=None, n_estimators=10, n_subspace_features_percentage=0.8, hard_voting=True, random_state=None):
        # Klasyfikator bazowy
        self.base_estimator = base_estimator
        # Liczba klasyfikatorow
        self.n_estimators = n_estimators
        # Liczba cech w jednej podprzestrzeni
        self.n_subspace_features_percentage = n_subspace_features_percentage
    ...
    def fit(self, X, y):
        ...
        self.max_features=round((self.n_subspace_features_percentage*self.n_features))
        ...
        self.subspaces = np.random.randint(0, self.n_features, (self.n_estimators, self.max_features))
    ...
    def predict(self, X):
        ...
        if self.hard_voting:
            ...
            # Liczenie glosow, zwraca indeksy 
